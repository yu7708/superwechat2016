...
public class MainActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null && savedInstanceState.getBoolean(Constant.ACCOUNT_REMOVED, false)) {
		    cn.ucai.superwechat.SuperWeChatDemoHelper.getInstance().logout(false,null);
			finish();
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	EMMessageListener messageListener = new EMMessageListener() {
		...
		public void onMessageReceived(List<EMMessage> messages) {
		    ...
		    for (EMMessage message : messages) {
		        cn.ucai.superwechat.SuperWeChatDemoHelper.getInstance().getNotifier().onNewMsg(message);
		    }
	...
	protected void onResume() {
		...
		// background
		SuperWeChatDemoHelper sdkHelper = cn.ucai.superwechat.SuperWeChatDemoHelper.getInstance();
	...
	private void registerInternalDebugReceiver() {
	    internalDebugReceiver = new BroadcastReceiver() {
            ...
            @Override
            public void onReceive(Context context, Intent intent) {
                cn.ucai.superwechat.SuperWeChatDemoHelper.getInstance().logout(false,new EMCallBack() {
